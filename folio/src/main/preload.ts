...
contextBridge.exposeInMainWorld('api', {
  ...
  restoreFolder: (id: string) => 
    ipcRenderer.invoke('restore-folder', id),
  getFolders: () => 
  ...
  restoreImage: (id: string) => 
    ipcRenderer.invoke('restore-image', id),
  updateImage: (id: string, updates: any) => 
  ...
  addTag: (imageId: string, tagName: string) => 
    ipcRenderer.invoke('add-tag', imageId, tagName),
  removeTag: (imageId: string, tagId: string) => 
    ipcRenderer.invoke('remove-tag', imageId, tagId),

  // Note operations
  saveNote: (imageId: string, markdown: string) => 
    ipcRenderer.invoke('save-note', imageId, markdown),
  getNote: (imageId: string) => 
    ipcRenderer.invoke('get-note', imageId),

  // Wallpaper
  setWallpaper: (imageId: string) => 
    ipcRenderer.invoke('set-wallpaper', imageId),
